...
async def on_message(message):
    ...
    if message.content == "!북미":
        await message.channel.send("https://drive.google.com/file/d/1eo70IxUzy4mcKJBdCaK060ihwdLBXsq_/view?usp=sharing ```구글 드라이브(링크)에서 html파일을 받고\nC:Battlestate Games/BsgLauncher/Content 폴더에 붙여넣기 (게임 설치한 폴더위치로)\n서버는 캘리포니아랑 워싱턴DC```")
